...
const RenderLeader = (props) => {
  return props.leaders.leaders.map((leader) => {
    return (
      <Media key={leader.id} tag='li' className='list-unstyled mt-5'>
        <Media left href='#'>
          <Media object src={baseUrl + leader.image} alt='Generic placeholder image' />
        </Media>
        <Media body className='ml-5'>
          <Media heading>
            <li className='font-weight-bold mb-1'>{leader.name}</li>
          </Media>
          <p className='mb-2'>{leader.designation}</p>
        ...
        <div className='row row-content'>
          <div className='col-12 col-md-6'>
            ...
            <p>
              ...
              the world, you never know what will arrive on your plate the next time you visit us.
            </p>
            <p>
